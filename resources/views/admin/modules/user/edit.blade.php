...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li>
            <a href='{{ route('admin.user.edit', ['id' => 1]) }}'>@yield('action')</a>
        </li>
    </ol>
</section>
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form id="add_users_form" action="{{ route('admin.user.edit', ['id' => 1]) }}" class="form-horizontal">
                                <div class="form-body">
